---
name: one-wiki
description: "Use when: 记笔记、存资料、总结聊天、更新笔记/文档、摄入/ingest、query/查询 Wiki、lint Wiki、parse/解析长文档，或触发词 qqq/Qqq、take notes、summarize chat、update notes。"
argument-hint: "note | ingest | query | lint | parse, 以及可选内容或问题"
---
