...
```bash
python3 ~/onespace/github/one-life/scripts/life.py search "五台山"
```
...
```bash
python3 ~/onespace/github/one-life/scripts/life.py recent 7     # 最近 7 天
python3 ~/onespace/github/one-life/scripts/life.py recent 30    # 最近 30 天
```
