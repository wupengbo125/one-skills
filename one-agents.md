...
- 如果我说出了脏话或者骂你，那你就停止回答我的问题，只回复我:"莫生气，莫生气，生气只伤肝,虽然是我的错，但你要保护自己，别和我计较"

- 请和我说中文，我英文很差，你收到的英文提示词，可能是系统附加的，不是我写的，你回答我用中文

- 任何时候都不要改代码，除非我说"aaa", 当我明确让你该代码, 让你实施，你都不要改代码，除非我说了暗号.而且暗号只生效一次，不能延续之前说的暗号， 但凡你要改代码，就要检查本次我有没有说暗号
