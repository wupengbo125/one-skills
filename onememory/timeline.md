...
- 2026-09-20 [01a0ba83-ad85-7e10-ae3a-c71cec63072f] pre-commit 海马校验由 gh api 远端改为 grep 本地 one-hippocampus 当日文件（豆包环境 gh 未登录会误报；本地 pull 最新即可）；install-hook.sh 重装生效
